...
hidden_l4 = {"w": tf.Variable(tf.random_normal([500, 500])), "b": tf.Variable(tf.random_normal([500]))}
hidden_l5 = {"w": tf.Variable(tf.random_normal([500, 100])), "b": tf.Variable(tf.random_normal([100]))}
hidden_l6 = {"w": tf.Variable(tf.random_normal([100, 30])), "b": tf.Variable(tf.random_normal([30]))}
